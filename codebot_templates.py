...
templates = {
        ...
        'E0602': make_templates('used a variable that is undefined. Remember that you just have to use the equal sign to assign a value to a variable.', 'used an undefined variable. Always assign a variable before accessing it.', [2]),
